...
public class PreloadDB {
    ...
    CommandLineRunner preloadData() {
        return args -> {
            ...
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
            log.info("preload {}", fr.save(new Video("Gavno2", "описание говна2", 1488, "example.mp4", "example.jpg", new Rating())));
