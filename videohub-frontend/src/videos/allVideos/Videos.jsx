                        ...
                        <div className="col-12">
                            ...
                            <div className="d-inline-flex gap-2 mb-2">
                                <div className="btn-group" role="group" aria-label="Basic example">
                                    <button onClick={() => setSortBy("new")} type="button" className={"btn btn" + (sortBy === "new" ? "" : "-outline") + "-secondary btn-lg"}>
                                    ...
                                    <button onClick={() => setSortBy("old")} type="button" className={"btn btn" + (sortBy === "old" ? "" : "-outline") + "-secondary btn-lg"}>
                                    ...
                                    <button onClick={() => setSortBy("views")} type="button" className={"btn btn" + (sortBy === "views" ? "" : "-outline") + "-secondary btn-lg"}>
                                    ...
                                    <button onClick={() => setSortBy("rating")} type="button" className={"btn btn" + (sortBy === "rating" ? "" : "-outline") + "-secondary btn-lg"}>
